...
?>
    ...
    <head>
        ...
        <meta name="description" content="Sarjana Komputer">
                            ...
                            <div class="panel-body" id="noti-box">
                                ...
                                ?>
                                    <div class="alert alert-success">
                                        ...
                                        <strong><?php echo $data3['fullname']; ?></strong>, Telah ditambahkan menjadi admin PerpustakaanUmi yang baru.
                                    </div>
                                <?php } ?>
                                ...
                                ?>
                                    <div class="alert alert-info">
                                        ...
                                        <strong><?php echo $data4['judul']; ?></strong>, Buku bacaan baru yang ada di PerpustakaanUmi
                                    </div>
                                <?php } ?>
                                ...
                                ?>
                                    <div class="alert alert-warning">
                                        ...
                                        <strong><?php echo $data5['nama']; ?> </strong> Pengunjung baru di PerpustakaanUmi
                                    </div>
                                <?php } ?>
                            </div>
                        </section>
